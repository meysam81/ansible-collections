...
Host-hygiene metrics (pending reboot, pending apt upgrades, held packages) in node-exporter textfile format on a systemd timer.

## Table of contents

- [Requirements](#requirements)
- [Default Variables](#default-variables)
  - [node_textfile_metrics_dir](#node_textfile_metrics_dir)
  - [node_textfile_metrics_dir_mode](#node_textfile_metrics_dir_mode)
  - [node_textfile_metrics_file_name](#node_textfile_metrics_file_name)
  - [node_textfile_metrics_on_calendar](#node_textfile_metrics_on_calendar)
  - [node_textfile_metrics_random_delay_sec](#node_textfile_metrics_random_delay_sec)
  - [node_textfile_metrics_script_path](#node_textfile_metrics_script_path)
...
### node_textfile_metrics_dir_mode

#### Default value

```YAML
node_textfile_metrics_dir_mode: '0755'
```

### node_textfile_metrics_file_name

#### Default value

```YAML
node_textfile_metrics_file_name: node_textfile_metrics.prom
```

### node_textfile_metrics_on_calendar

#### Default value

```YAML
node_textfile_metrics_on_calendar: '*:0/15'
```

### node_textfile_metrics_random_delay_sec

#### Default value

```YAML
node_textfile_metrics_random_delay_sec: 120
```

### node_textfile_metrics_script_path

#### Default value

```YAML
node_textfile_metrics_script_path: /usr/local/bin/node-textfile-metrics.sh
```
