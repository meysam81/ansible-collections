...
Minimal, auditable sshd hardening via a single sshd_config.d drop-in

## Table of contents

- [Requirements](#requirements)
- [Default Variables](#default-variables)
  - [sshd_hardening_allow_agent_forwarding](#sshd_hardening_allow_agent_forwarding)
  - [sshd_hardening_allow_tcp_forwarding](#sshd_hardening_allow_tcp_forwarding)
  - [sshd_hardening_allow_users](#sshd_hardening_allow_users)
  - [sshd_hardening_ciphers](#sshd_hardening_ciphers)
  - [sshd_hardening_client_alive_count_max](#sshd_hardening_client_alive_count_max)
  - [sshd_hardening_client_alive_interval](#sshd_hardening_client_alive_interval)
  - [sshd_hardening_dropin_path](#sshd_hardening_dropin_path)
  - [sshd_hardening_extra_options](#sshd_hardening_extra_options)
  - [sshd_hardening_kbd_interactive_authentication](#sshd_hardening_kbd_interactive_authentication)
  - [sshd_hardening_kex_algorithms](#sshd_hardening_kex_algorithms)
  - [sshd_hardening_log_level](#sshd_hardening_log_level)
  - [sshd_hardening_login_grace_time](#sshd_hardening_login_grace_time)
  - [sshd_hardening_macs](#sshd_hardening_macs)
  - [sshd_hardening_max_auth_tries](#sshd_hardening_max_auth_tries)
  - [sshd_hardening_max_sessions](#sshd_hardening_max_sessions)
  - [sshd_hardening_password_authentication](#sshd_hardening_password_authentication)
  - [sshd_hardening_permit_empty_passwords](#sshd_hardening_permit_empty_passwords)
  - [sshd_hardening_permit_root_login](#sshd_hardening_permit_root_login)
  - [sshd_hardening_pubkey_authentication](#sshd_hardening_pubkey_authentication)
  - [sshd_hardening_x11_forwarding](#sshd_hardening_x11_forwarding)
...
### sshd_hardening_allow_agent_forwarding

#### Default value

```YAML
sshd_hardening_allow_agent_forwarding: no
```

### sshd_hardening_allow_tcp_forwarding

#### Default value

```YAML
sshd_hardening_allow_tcp_forwarding: no
```
...
```YAML
sshd_hardening_dropin_path: /etc/ssh/sshd_config.d/00-hardening.conf
```

### sshd_hardening_extra_options
...
```YAML
sshd_hardening_kbd_interactive_authentication: no
```
...
```YAML
sshd_hardening_max_sessions: 10
```
...
```YAML
sshd_hardening_password_authentication: no
```
...
```YAML
sshd_hardening_permit_empty_passwords: no
```
...
```YAML
sshd_hardening_permit_root_login: prohibit-password
```

### sshd_hardening_pubkey_authentication

#### Default value

```YAML
sshd_hardening_pubkey_authentication: yes
```
