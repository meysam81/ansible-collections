...
Lynis security auditing on a timer, exposing hardening index and finding counts as textfile metrics

## Table of contents

- [Requirements](#requirements)
- [Default Variables](#default-variables)
  - [lynis_file_name](#lynis_file_name)
  - [lynis_on_calendar](#lynis_on_calendar)
  - [lynis_profile_extra](#lynis_profile_extra)
  - [lynis_randomized_delay](#lynis_randomized_delay)
  - [lynis_script_path](#lynis_script_path)
  - [lynis_skip_tests](#lynis_skip_tests)
  - [lynis_textfile_dir](#lynis_textfile_dir)
...
### lynis_randomized_delay

#### Default value

```YAML
lynis_randomized_delay: 1h
```
...
```YAML
lynis_script_path: /usr/local/bin/lynis-metrics
```
