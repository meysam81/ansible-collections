...
Publish DANE TLSA (3 1 1) records to Cloudflare from a cert file. Designed to hook into lego cert-renewal so the SPKI hash stays in lockstep with the live cert. Add-only by default; manual cleanup after key rotation.

## Table of contents

- [Requirements](#requirements)
- [Default Variables](#default-variables)
  - [dane_certs](#dane_certs)
  - [dane_cloudflare_api_token](#dane_cloudflare_api_token)
  - [dane_cloudflare_zone_id](#dane_cloudflare_zone_id)
  - [dane_config_dir](#dane_config_dir)
  - [dane_enabled](#dane_enabled)
  - [dane_record_ttl](#dane_record_ttl)
  - [dane_script_path](#dane_script_path)
...
```YAML
dane_script_path: /usr/local/bin/dane-publish.sh
```
