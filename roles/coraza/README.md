...
| `coraza_rule_engine` | `DetectionOnly` | `SecRuleEngine` written into `coraza.conf`: `DetectionOnly` only logs (upstream default), `On` blocks. |
...
- [Default Variables](#default-variables)
  ...
  - [coraza_spoe_log_events](#coraza_spoe_log_events)
...
### coraza_spoe_log_events

#### Default value

```YAML
coraza_spoe_log_events: false
```
