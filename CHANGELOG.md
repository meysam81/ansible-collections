...
## [1.13.0](https://github.com/meysam81/ansible-collections/compare/v1.12.0...v1.13.0) (2026-09-05)


### Features

* add postfix, dovecot & restic backup ([5955da6](https://github.com/meysam81/ansible-collections/commit/5955da67cd4b29ed4b5006882ec3c9355c2aaf13))
* add PQC to postfix and default-backend URL to haproxy ([f03c2e6](https://github.com/meysam81/ansible-collections/commit/f03c2e632f2046ea7ef224934ec94719756d0bc9))
* add supervisor role and optimize haproxy & unbound ([ffadfb9](https://github.com/meysam81/ansible-collections/commit/ffadfb9ea10b51ff7b0e5b7b10f30e24da0872ca))
* add unbound role ([69abad9](https://github.com/meysam81/ansible-collections/commit/69abad9bebee940c055ecf5c386ad7f3027376a4))
...
* increase the default security level of haproxy & postfix ([b4d27e2](https://github.com/meysam81/ansible-collections/commit/b4d27e2c4543505a8067a620c87e24dd65263aac))
* **node_textfile_metrics:** host hygiene metrics on a timer; node_exporter listen and textfile variables ([#113](https://github.com/meysam81/ansible-collections/issues/113)) ([60f4163](https://github.com/meysam81/ansible-collections/commit/60f4163b93a7a2e80dd46a68b4ccd42254e6359b))
* observability roles (alloy, postfix_exporter, dovecot metrics, restic metrics, lego resolvers) ([#111](https://github.com/meysam81/ansible-collections/issues/111)) ([dd30c0a](https://github.com/meysam81/ansible-collections/commit/dd30c0a18571bbb9a78e7f9e39a3da615df2a8db))
...
* **lego:** add reuse-key only to renew subcommand ([559db10](https://github.com/meysam81/ansible-collections/commit/559db108e7c064aea11e46cac7e22854a15dff42))
* remove default alt-svc from haproxy ([cad03b6](https://github.com/meysam81/ansible-collections/commit/cad03b606f877bb99a7bd73fabb102a2c94ea45f))
...
* **unbound:** disable forwarders for unbound and mask unbound-resolvconf ([47c9ad0](https://github.com/meysam81/ansible-collections/commit/47c9ad0fe65898e96b45cb7261069c16c375509a))
* **unbound:** use absolute path for apparmor ([012ddfa](https://github.com/meysam81/ansible-collections/commit/012ddfa6be45dc7ec4c10bd6331c3fe01379eb0c))
